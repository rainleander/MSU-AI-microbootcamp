...
20. Document any findings from comparing the different approaches with this dataset. Make sure to specify which approach you would recommend with this dataset along with any other interpretations you can make from the results.
